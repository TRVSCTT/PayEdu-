...
export function EstablishmentPaymentsPage() {
  const { data: paiements, isLoading } = useQuery({
    queryKey: ['etablissement-paiements'],
    queryFn: etablissementService.getPaiements
  });
  ...
  return (
    <DashboardLayout
      ...
      description="Vue globale sur toutes les transactions financières de l'établissement."
    >
      <div className={cardStyles('p-6')}>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <PageHeader title="Transactions Récentes" />
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p>Aucun paiement n'a encore été enregistré.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="py-3 px-4 font-semibold text-sm text-gray-500">Objet</th>
                  <th className="py-3 px-4 font-semibold text-sm text-gray-500">Montant</th>
                  <th className="py-3 px-4 font-semibold text-sm text-gray-500">Méthode</th>
